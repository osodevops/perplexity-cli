...
use super::types::{ApiErrorResponse, SearchRequest, SearchResponse};

impl ApiClient {
    /// Send a search request to POST /search.
    pub async fn search(&self, request: &SearchRequest) -> Result<SearchResponse, PplxError> {
